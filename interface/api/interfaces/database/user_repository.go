...
// MySQLUserRepository is repository of user to save on MySQL
...
func (r *mySQLUserRepository) Store(db *sqlx.DB, u domain.User) (int, error) {
	// prepared statement
	// SQL Injection対策
...
func (r *mySQLUserRepository) FindAll(db *sqlx.DB) (domain.Users, error) {
